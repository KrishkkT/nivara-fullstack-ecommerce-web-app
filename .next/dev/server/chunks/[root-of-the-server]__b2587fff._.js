...
"[project]/Downloads/nivara-e-commerce-website/app/api/admin/emails/remove/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const activeEmails = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$nivara$2d$e$2d$commerce$2d$website$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
      SELECT COUNT(*) as count FROM admin_emails WHERE is_active = true
    `;
        if (activeEmails[0].count <= 1) {
            const emailToRemove = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$nivara$2d$e$2d$commerce$2d$website$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
        SELECT is_active FROM admin_emails WHERE id = ${Number.parseInt(id)}
      `;
            if (emailToRemove.length > 0 && emailToRemove[0].is_active) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$nivara$2d$e$2d$commerce$2d$website$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Cannot remove the last active email"
                }, {
                    status: 400
                });
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b2587fff._.js.map